<template>
    <div class="addDetail-Page">
        <div class="header-list" v-if='organization!="3"'>
            <div>送检机构选择 <sup>*</sup></div>
            <div>
                <img src="@/assets/img/jinxiang/ruiangActive-icon.png" alt="" srcset="">
                睿昂
            </div>
            <div v-if="organization =='1' || organization =='0,1'" :class="{active:organization=='0' || organization=='0,1'}" @click="jingxiangChange()">
                <img src="@/assets/img/jinxiang/jinxiangNo-icon.png" alt="" srcset="">
                金橡 
                <span>指定医院</span>
            </div>
        </div>
        <div v-if="organization=='3'" style="margin-top:41.5vw"></div>
        <div class="header-box">
            ...
            <div class="content-box">
                ...
                <div class="content-info-user-name" style="grid-template-columns: 40% 60%;">
                    ...
                    <div class="right">
                        <input  placeholder="请输入数值" v-model="adduser.ldh_exp" style="width:50vw;margin-left:-5vw" class="select-input" type="text" />
                    </div>
                </div>
                ...
                <div class="content-info-user-name" style="grid-template-columns: 40% 60%;">
                    ...
                    <div class="right">
                        <input  placeholder="请输入数值" v-model="adduser.MYCCascade" style="width:50vw;margin-left:-5vw" class="select-input" type="text" />
                    </div>
                </div>
...
export default {
    ...
    data(){
        return{
            ...
            //logisticsCompanySelect:['顺丰快递','京东快递','其他快递'],
    ...
    methods:{
            ...
            params: {
                ...
                if(res.data.s){
                    ...
                    if(res.data.data && res.data.data !=''){
                        ...
                        that.organization  = es.data.data.organization;
                        if(res.data.data.organization == '0'){
                            that.ruiangClick = false;
                            that.organization = '0';
                        }else if(res.data.data.organization == '0,2'){
                            that.ruiangClick = false;
                            that.organization = '0,2';
                        }else{
                            if(res.data.data.organization == '1' || res.data.data.organization == '0,1'){
                                that.organization = '1';
                                that.ruiangClick = true;
                            }else if(res.data.data.organization == '2' ){
                                that.organization = '2';
                            }else{
                                that.organization = '3';
                            }
            ...
            params: {
                ...
                if(res.data.s){
                    ...
                    if(res.data.data && res.data.data !=''){
                        ...
                        that.adduser.agree_img=res.data.data.agree_img;
        ...
        checkCodeChange(){
            ...
            params: {
                ...
                type:'0'//0：睿昂（G-02,B+）；1:金橡（B+），2:天晴
            }
            }).then(function (res) {
                console.log(res.data);
                if(res.data.s){
        ...
        initSearch(hospitalVal){
            let that = this;
            if(this.joinType =='B'){
                if(this.organization =='0' || this.organization =='0,1'){
                    var organization = '0';
                }
            }else if(this.joinType =='CE02'){
                if(this.organization =='2' || this.organization =='0,2'){
                    var organization = '1';
                }
            }else{
                var organization = '2';
            ...
            that.axios.get('/api/NHL/GetUnitV2',{
            params: {
        ...
        addSubmitChange(){
            ...
            if(that.id){
                ...
                console.log(that.joinType)
                if(that.joinType =='B'){
                    if(that.organization =='0' || that.organization =='0,1'){
                        var organization = '0';
                    }
                }else if(that.joinType =='CE02'){
                    if(that.organization =='2' || that.organization =='0,2'){
                        var organization = '1';
                    }
                }else{
                    var organization = '2';
                ...
                //TODO
                that.axios.post('/api/NHL/CreateInfoV3', promise)
                .then(function (res) {
                    console.log(res);
        ...
        editAddSubmit(){
            ...
            that.axios.post('/api/NHL/UpdateInfoV3', promise)
            .then(function (res) {
                console.log(res);
                if(res.status && res.status ==200){
                    if(res.data.s){
